...
from nova.virt.vcmvmwareapi import io_util
from nova.virt.vcmvmwareapi import vm_util

# NOTE(mdbooth): We use use_linked_clone below, but don't have to import it
# because nova.virt.vcmvmwareapi.driver is imported first. In fact, it is not
# possible to import it here, as nova.virt.vcmvmwareapi.driver calls
...
class VMwareImage(object):
    ...
    def from_image(cls, image_id, image_meta):
        ...
        :rtype: nova.virt.vcmvmwareapi.images.VmwareImage
        """
