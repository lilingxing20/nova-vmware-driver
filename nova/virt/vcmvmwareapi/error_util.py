...
class VimException(Exception):
    ...
    def __unicode__(self):
        return u'%s: %s' % (self.exception_summary, self.exception_obj)
...
class VMotionInterfaceException(VMwareDriverException):
    msg_fmt=_("The vMotion interface exception: %(param)s")
